...
if (isset($_GET["folder_path"]))
	...
	echo "<b>You need to provide the path of the folder you want to browse to browse like this</b><br> cgi/scripts/rss_browse_folder.php?folder_path=media or cgi/scripts/rss_browse_folder.php?folder_path=media&recursive=true";
	echo "<br>";
	echo "<br>";
...
//	if (is_file($filePath_tmp) || ($allow_folder=="true" && is_dir($filePath_tmp)))
	{
...
function flattenArray($array,$folder)
{
   ...
   foreach( $array as $subElement ) {
       ...
       if(is_array($subElement[constant("file_system_tools::itemContentField")]) )
